<aside class="app-sidebar sticky" id="sidebar">
    ...
    <div class="main-sidebar" id="sidebar-scroll" data-simplebar="init">
                                ...
                                <ul class="main-menu active" style="margin-left: 0px; margin-right: 0px;">
                                    ...
                                    <li class="slide has-sub">
                                        ...
                                        <ul class="slide-menu child1"
                                            style="position: relative; left: 0px; top: 0px; margin: 0px; transform: translate3d(127px, 654.5px, 0px);"
        ...
        <div class="simplebar-track simplebar-vertical" style="visibility: visible;">
            <div class="simplebar-scrollbar"
                style="height: 438px; transform: translate3d(0px, 21px, 0px); display: block;"></div>
        </div>
    </div>
    <!-- End::main-sidebar -->
